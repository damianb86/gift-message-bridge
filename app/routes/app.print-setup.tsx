            ...
            <div className={styles.printPreviewModal}>
              ...
              <div className={styles.printPreviewBody}>
                ...
                <div className={styles.printPreviewSummary}>
                  <div className={styles.printPresetPicker}>
                    <span className={styles.printPresetLabel}>
                      Print preset
                    </span>
                    <div
                      className={styles.printPresetGrid}
                      role="radiogroup"
                    ...
                    >
                      {printTemplates.map((template) => (
                        <button
                          ...
                          style={getTemplateStyle(template.id)}
                          onClick={() =>
                            handlePrintPreviewTemplateChange(template.id)
                          }
                          role="radio"
                          aria-checked={template.id === selectedTemplateId}
                        >
